...
namespace GOL
{
    ...
    {
    public:
        static bool dies_underpopulation(Cell, WorldMap);
        static bool lives_next_generation(Cell, WorldMap);
        static bool dies_overpopulated(Cell, WorldMap);
        static bool lives_reproduced(Cell, WorldMap);
